    ...
    return (
        <div class="headerstyle1">
            <div class="cover-image bg-background3" data-image-src="/assets/images/banners/banner4.jpg">
                <DashHeader pageName="Manged Items" />
            </div>
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-12">
                            ...
                            <div class="card manged-ad">
                                ...
                                <div class="row ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$24</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                ...
                                <div class="row border-top ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$56</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                ...
                                <div class="row border-top ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$22</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                ...
                                <div class="row border-top ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$18</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                ...
                                <div class="row border-top ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$25</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                ...
                                <div class="row border-top ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$14</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                ...
                                <div class="row border-top ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$35</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                ...
                                <div class="row border-top ml-0 mr-0">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
                                            <h3 class="font-weight-semibold fs-20">$12</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card-body">
