				...
				<div className="row">
					<div className="col-lg-7 col-xl-6 col-md-12">
						<div className="sub-newsletter">
							<h3 className="mb-2 fs-20"><i className="fa fa-paper-plane-o mr-2"></i> Subscribe To Our Onlinesletter</h3>
...
export default SubscribeOnlineLetters;